    ...
    <div className="space-y-6 mt-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <Card className="border-l-4 border-l-gray-500 shadow-sm">
          <CardContent className="p-6">
            <div className="text-center">
              <div className="text-2xl font-bold text-gray-700 mb-2">REQUESTS</div>
              <div className="text-3xl font-bold text-gray-900">{summaryStats.totalRequests}</div>
            </div>
          </CardContent>
        </Card>
        ...
        <Card className="border-l-4 border-l-green-500 shadow-sm">
          <CardContent className="p-6">
            <div className="text-center">
              <div className="text-2xl font-bold text-green-700 mb-2">RECEIVED</div>
              <div className="text-3xl font-bold text-green-900">{summaryStats.receivedPercentage}%</div>
            </div>
          </CardContent>
        </Card>
        ...
        <Card className="border-l-4 border-l-blue-500 shadow-sm">
          <CardContent className="p-6">
            <div className="text-center">
              <div className="text-2xl font-bold text-blue-700 mb-2">UTILIZED</div>
              <div className="text-3xl font-bold text-blue-900">{summaryStats.utilizedPercentage}%</div>
            </div>
          </CardContent>
        </Card>
      </div>
      ...
      <Card className="border-l-4 border-l-red-500 shadow-sm">
        ...
        <CardContent>
          <div className="text-center text-2xl font-bold text-red-700 mb-4">
          ...
          <div className="flex items-center justify-center mb-6 p-4">
            <div className="relative w-64 h-64">
              ...
              <div className="absolute inset-0 flex items-center justify-center">
                <div className="text-center">
                  <div className="text-2xl font-bold text-red-700">{percentReceived}%</div>
            ...
            <TableBody>
              {paginatedMaterials.map((material: Material, index: number) => {
                ...
                >
                  ...
                  <TableCell className="text-blue-600 font-medium">{material.totalQuantity}</TableCell>
                  <TableCell className="text-orange-600 font-medium">{material.requestedQuantity}</TableCell>
                  <TableCell
                    className={
                  ...
                  <TableCell className="text-blue-600 font-medium">{material.utilizedQuantity}</TableCell>
                  <TableCell>
                    <Badge 
                      variant="outline" 
      ...
      {selectedMaterial && selectedMaterial.purchaseOrders.length > 0 && (
        <Card className="border-l-4 border-l-orange-500 shadow-sm">
          <CardHeader>
            <CardTitle className="text-orange-600 text-base font-semibold">
              ...
              <TableBody>
                {selectedMaterial.purchaseOrders.map((po) => (
                  <TableRow key={po.id}>
                    ...
                    <TableCell>{new Date(po.date_requested).toLocaleDateString('en-GB')}</TableCell>
                    <TableCell>{new Date(po.expected_delivery_date).toLocaleDateString('en-GB')}</TableCell>
                    <TableCell className="font-medium">{po.qty} {po.unit}</TableCell>
                    <TableCell>
                      <Badge 
                        variant="outline" 
                        className={`text-xs ${
