      ...
      <div className="w-full mx-4 sm:mx-6 lg:mx-8 space-y-4 sm:space-y-6 lg:space-y-8 py-4 sm:py-6 lg:py-8">
        ...
        <div className="flex flex-wrap gap-3 sm:gap-4 pt-4">
          <button
            ...
            className="inline-flex items-center justify-center rounded-md border border-border bg-card px-4 py-2.5 sm:py-2 text-sm font-medium text-muted-foreground hover:text-foreground hover:bg-muted transition-colors mobile-touch-target min-h-[44px] flex-1 sm:flex-none sm:min-w-[100px] disabled:opacity-50"
          >
            Cancel
          </button>
          {currentSection > 1 && (
          ...
          {currentSection < totalSections ? (
            <button
              ...
              className="inline-flex items-center justify-center rounded-md bg-primary px-4 py-2.5 sm:py-2 text-sm font-medium text-primary-foreground hover:bg-[hsl(var(--arsd-red-hover))] transition-colors duration-150 active:scale-[0.98] mobile-touch-target min-h-[44px] flex-1 sm:flex-none sm:min-w-[120px] disabled:opacity-50 disabled:cursor-not-allowed"
            >
              Next
            </button>
          ) : (
