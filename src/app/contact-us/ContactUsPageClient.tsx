    ...
    <div className="min-h-[100dvh] bg-[#111111]">
      ...
      <section className="py-20 sm:py-28 bg-[#111111]">
        <div className="responsive-container">
          ...
          <h1 className="font-display text-5xl sm:text-6xl lg:text-7xl tracking-tighter text-[#f0ede8] uppercase leading-none mb-6 max-w-2xl">
            Contact ARSD Construction — Iloilo City General Contractor
          </h1>
      ...
      <section className="py-16 sm:py-20 bg-[#1c1c1c]">
        <div className="responsive-container">
          ...
          <h2 className="font-display text-3xl sm:text-4xl tracking-tight text-[#f0ede8] uppercase mb-3">
            Find Us
          </h2>
          <p className="text-[#a09890] leading-relaxed mb-10 max-w-[55ch]">
            Visit our office in Arevalo, Iloilo City.
          </p>
          <div className="grid lg:grid-cols-2 gap-8 items-start">
            ...
            <div className="rounded-lg overflow-hidden h-[400px] border border-[#2a2626] shadow-lg">
              {/* TODO: operator should replace this with the exact Google Maps share-embed URL for the ARSD office (Maps → Share → Embed a map → copy iframe src) */}
              <iframe
                src="https://www.google.com/maps?q=Figueroa+St,+Arevalo,+Iloilo+City+5000,+Philippines&output=embed"
                width="100%"
                className="h-full"
                style={{ border: 0 }}
                loading="lazy"
                ...
                title="ARSD Construction Corporation office location — Figueroa St., Arevalo, Iloilo City"
                aria-label="ARSD Construction Corporation office location — Figueroa St., Arevalo, Iloilo City"
              />
            </div>
          </div>
        </div>
